                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="row">
                        <div class="card-heading d-flex justify-content-between">
                            <div>
                                <h4>Home Design Contact Lists</h4>
                                <p>
                                    You can search the contact by <a href="#" class="card-heading-link">name , email and phone number</a>  can view all available Design Contact list records.
                                </p>
                            </div>
                            <ul class="admin-breadcrumb">
                                <li><a href="{{url('super-admin')}}" class="card-heading-link">Home</a></li>
                                <li>Design Contact</li>
                            </ul>
                        </div>
                        {!! Form::open(['url' => 'super-admin/designs', 'method' => 'GET']) !!}
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row">
                            ...
                            <div class="card-wrap form-block p-0">
                                <div class="block-header bg-header d-flex justify-content-between p-4">
                                    <div class="d-flex flex-column">
                                        <h3>Home Design Contact's Table</h3>
                                    </div>
                                </div>
                                                    ...
                                                    <table class="table" id="">
                                                        ...
                                                        @foreach($settings as $setting)
                                                            <tr id="my-table-tr-{{$setting->id}}">
                                                                ...
                                                                <td>{{$setting->email}}</td>
                                                                <td>{{$setting->phone}}</td>
                                                                <td>{{config('custom.design_types')[$setting->design_type]}}</td>
                                                                <td>{{$setting->message}}</td>
                                                                <td class="action-icons">
                                                                    <ul class="icon-button d-flex">
                                                                        <li>
                                                                            <a class="dropdown-item"
                                                                               href="{{url('super-admin/designs/'.$setting->id)}}"
                                                                               role="button"><i class="fa-solid fa-eye" data-bs-toggle="tooltip" data-bs-title="Show"></i></a>
                                                                        </li>
                                                                        <li>
                                                                            <a class="dropdown-item"  role="button" onclick="myDelete({{$setting->id}})"><i class="fa-solid fa-trash" data-bs-toggle="tooltip" data-bs-title="Delete"></i></a>
                                                                        </li>
                                                                    </ul>
                                                                </td>
                                                            </tr>
                    ...
                    tryAgain: {
                        ...
                        action: function () {
                            ...
                            $.ajax({
                                ...
                                type: 'POST',
                                url: Laravel.url + "/super-admin/designs-delete",
                                dataType: 'json',
                                data: formData,
