                    ...
                    <div class="row">
                        <div class="card-heading d-flex justify-content-between">
                            <div>
                                <h4>Enquiry Lists</h4>
                                <p>
                                    You can search the enquiry by <a href="#" class="card-heading-link"> name or
                                        email</a> and phone no. can view all available enquiry records.
                                </p>
                            </div>
                        ...
                        {!! Form::open(['url' => 'super-admin/enquiries', 'method' => 'GET']) !!}
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row">
                                                                    ...
                                                                    <ul class="icon-button d-flex">
                                                                        <li>
                                                                            <a class="dropdown-item"
                                                                               href="{{url('super-admin/enquiries/'.$setting->id)}}"
