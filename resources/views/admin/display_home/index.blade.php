                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="row">
                        <div class="card-heading d-flex justify-content-between">
                            <div>
                                <h4>Display Home Lists</h4>
                                <p>
                                    You can search the display home by <a href="#" class="card-heading-link">name</a>
                                    and can view all available display home records.
                                </p>
                            </div>
                        ...
                        {!! Form::open(['url' => 'super-admin/display-homes', 'method' => 'GET']) !!}
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row">
                            ...
                            <div class="card-wrap form-block p-0">
                                <div class="block-header bg-header d-flex justify-content-between p-4">
                                    <div class="d-flex flex-column">
                                        <h3>Display Home's Table</h3>
                                    </div>
                                    <div class="add-button">
                                        <a class="nav-link" href="{{url('super-admin/display-homes/create')}}"><i
                                                class="fa-solid fa-book-open"></i>&nbsp;&nbsp Add Display Home</a>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 table-responsive table-details">
                                                    <table class="table" id="">
                                                        ...
                                                        <tr>
                                                            <th scope="col">S.N.</th>
                                                            <th scope="col">Display Home Name</th>
                                                                    ...
                                                                    <ul class="icon-button d-flex">
                                                                        <li>
                                                                            <a class="dropdown-item"
                                                                               href="{{url('super-admin/display-homes/'.$setting->id)}}"
                                                                        ...
                                                                        <li>
                                                                            <a class="dropdown-item"
                                                                               href="{{url('super-admin/display-homes/'.$setting->id.'/edit')}}"
                    ...
                    tryAgain: {
                        ...
                        action: function () {
                            ...
                            $.ajax({
                                ...
                                type: 'POST',
                                url: Laravel.url + "/super-admin/display-homes-delete",
                                dataType: 'json',
                                data: formData,
