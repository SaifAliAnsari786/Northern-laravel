                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="card-wrap form-block p-0">
                        ...
                        <div class="row p-4 form-wrap">
                            {!! Form::open(['url' => 'super-admin/display-homes', 'class' =>  'row g-2 ps-2 pe-0 me-0', 'method' => 'POST', 'files' => true, 'onsubmit' => 'return validateForm()']) !!}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="suburb" name="suburb" class="form-select"
                                                ...
                                                @foreach(config('custom.australian_states') as $in1_su => $val1_su)
                                                    <option value="{{$in1_su}}"
                                                            @if(old('suburb') == $in1_su) selected @endif>{{$val1_su}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function validateSlug() {
            ...
            if (name != '' || name != null) {
                ...
                $.ajax({
                    type: 'POST',
                    url: Laravel.url + '/super-admin/display-homes/check-slug',
