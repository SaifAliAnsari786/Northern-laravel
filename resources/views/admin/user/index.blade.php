                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="row">
                        <div class="card-heading d-flex justify-content-between">
                            <div>
                                <h4>Wish List User</h4>
                                <p>
                                    You can search the user by <a href="#" class="card-heading-link"> name or
                                        email</a>. can view all available user records.
                                </p>
                            </div>
                        ...
                        {!! Form::open(['url' => 'super-admin/user', 'method' => 'GET']) !!}
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row">
                                                                    ...
                                                                    <ul class="icon-button d-flex">
                                                                        <li>
                                                                            <a class="dropdown-item"
                                                                               href="{{url('super-admin/user/'.$setting->id)}}"
                    ...
                    tryAgain: {
                        ...
                        action: function () {
                            ...
                            $.ajax({
                                ...
                                type: 'POST',
                                url: Laravel.url + "/super-admin/user-delete",
                                dataType: 'json',
                                data: formData,
