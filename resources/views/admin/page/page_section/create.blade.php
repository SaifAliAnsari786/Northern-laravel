                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="card-wrap form-block p-0">
                        ...
                        <div class="row p-4 form-wrap">
                            {!! Form::open(['url' => 'super-admin/pages-section/'.$page->id, 'class' =>  'row g-2 ps-2 pe-0 me-0', 'method' => 'POST', 'files' => true, 'onsubmit' => 'return validateForm()']) !!}
                                    ...
                                    <div class="row gy-3">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control form-control-lg"
                                                               name="section_name"
                                                               id="section_name" value="{{old('section_name')}}"
                                                               required>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="section_description" id="body1" cols="30"
                                                      ...
                                                      placeholder="">{{old('section_description')}}</textarea>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="section_radio"
                                                       id="section_radio_no1" value="2" checked
