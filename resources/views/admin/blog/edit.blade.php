                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="card-wrap form-block p-0">
                        <div class="block-header p-4">
                            <h3>Edit Blog</h3>
                            <p class="ms-4 mb-0">Fill the following fields to edit new blog.</p>
                        ...
                        <div class="row p-4 form-wrap">
                            {!! Form::open(['url' => 'super-admin/blogs/'.$setting->id, 'class' =>  'row g-2 ps-2 pe-0 me-0', 'method' => 'POST', 'files' => true, 'onsubmit' => 'return validateForm()']) !!}
    ...
    <script>
        ...
        function validateSlug(id) {
            ...
            if (name != '' || name != null) {
                ...
                $.ajax({
                    type:'POST',
                    url:Laravel.url+'/super-admin/blogs/check-slug-edit',
