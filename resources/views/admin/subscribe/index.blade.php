                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="row">
                        <div class="card-heading d-flex justify-content-between">
                            <div>
                                <h4>Subscribe Lists</h4>
                                <p>
                                    You can search the subscriber by <a href="#" class="card-heading-link">email</a>  can view all available subscribe records.
                                </p>
                            </div>
                        ...
                        {!! Form::open(['url' => 'super-admin/subscribes', 'method' => 'GET']) !!}
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row">
                                    <div class="filter-btnwrap justify-content-between">
                                        <div class="d-flex">
                                            <div class="input-group mx-4">
                                                ...
                                                <input type="text" class="form-control reset-class"  placeholder="email" name="name" value="{{old('name')}}"/>
                                            </div>
                    ...
                    tryAgain: {
                        ...
                        action: function () {
                            ...
                            $.ajax({
                                ...
                                type: 'POST',
                                url: Laravel.url + "/super-admin/subscribes-delete",
                                dataType: 'json',
                                data: formData,
