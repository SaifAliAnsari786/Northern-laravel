                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="card-wrap form-block p-0">
                        <div class="block-header p-4">
                            <h3>Edit FAQ's</h3>
                            <p class="ms-4 mb-0">Fill the following fields to edit faqs.</p>
                        ...
                        <div class="row p-4 form-wrap">
                            {!! Form::open(['url' => 'super-admin/faqs/'.$setting->id, 'class' =>  'row g-2 ps-2 pe-0 me-0', 'method' => 'POST']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-lg"   name="question" id="question" value="{{$setting->question}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
