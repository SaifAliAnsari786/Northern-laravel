                    ...
                    <div class="card-wrap form-block p-0">
                        <div class="block-header p-4">
                            ...
                            <div class="tbl-buttons">
                                <ul>
                                    <li>
                                        <a href="{{url('super-admin/seo')}}"><img src="{{url('images/cancel-icon.png')}}" alt="cancel-icon"/></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="row p-4 form-wrap">
                            {!! Form::open(['url' => 'super-admin/seo/'.$setting->id, 'class' =>  'row g-2 ps-2 pe-0 me-0', 'method' => 'POST', 'files' => true, 'onsubmit' => 'return validateForm()']) !!}
