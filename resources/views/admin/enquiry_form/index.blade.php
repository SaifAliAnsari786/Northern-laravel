                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="row">
                        <div class="card-heading d-flex justify-content-between">
                            <div>
                                <h4>Enquiry Form Lists</h4>
                                <p>
                                    You can search the Working NDS Enquiry Form by <a href="#" class="card-heading-link"> name or
                        ...
                        {!! Form::open(['url' => 'super-admin/form', 'method' => 'GET']) !!}
                        <div class="row">
                            <div class="col-md-11">
                                <div class="row">
                                                ...
                                                <div class="col-12 table-responsive table-details">
                                                    <table class="table" id="">
                                                        ...
                                                        @foreach($forms as $form)
                                                            <tr id="my-table-tr-{{$form->id}}">
                                                                <td>{{ $loop->iteration }}</td>
                                                                <td>{{$form->enquirer_name}}</td>
                                                                <td>{{$form->email}}</td>
                                                                <td>{{$form->phone_no}}</td>
                                                                <td>{{$form->participant_name}}</td>
                                                                <td>{!! Illuminate\Support\Str::limit($form->message, 50) !!}</td>
                                                                <td>
                                                                <img src="{{ url($form->image) }}" alt="" style="width: 100px;">
                                                                    ...
                                                                    <ul class="icon-button d-flex">
                                                                        <li>
                                                                            <a class="dropdown-item"
                                                                               href="{{url('super-admin/form/'.$form->id)}}"
                                                                        ...
                                                                        <li>
                                                                        <a class="dropdown-item"
                                                                            href="{{ url('super-admin/form/delete/' . $form->id) }}"
                                                                            role="button"><i
