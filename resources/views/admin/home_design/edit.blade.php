                ...
                <div class="col-sm-12 col-md-12 stretch-card">
                    <div class="card-wrap form-block p-0">
                        ...
                        <div class="row p-4 form-wrap">
                            {!! Form::open(['url' => 'super-admin/home-designs/'.$setting->id, 'class' =>  'row g-2 ps-2 pe-0 me-0', 'method' => 'POST', 'files' => true]) !!}
                            <div class="form-group batch-form">
                                <div class="col-md-12">
                                    ...
                                    <div class="image-upload_item form-grp mt-4">
                                        <div id="imageDomAll">
                                            @foreach($setting->homeDesignImages as $homeDesignImage)
                                ...
                                <div class="features-upload_item form-grp mt-4 mb-2">
                                    <div id="featureDomAll">
                                        @foreach($setting->designFeatures as $designFeature)
                                ...
                                <div class="floor-plan_item form-grp mt-4">
                                    <div id="roomDimensionAll">
                                        @foreach($setting->designDimensions as $designDimension)
